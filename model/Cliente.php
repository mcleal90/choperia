...
// private $id_mesa_cliente;
    class cliente {
        ...
        return $this-> id_cliente = $status_cliente;
        }
        function setData_cliente($data_cliente) {
            return $this-> id_cliente = $data_cliente;
        }
        function setId_comanda_cliente($id_comanda_cliente) {
            return $this-> id_cliente = $id_comanda_cliente;
        }
        function setId_mesa_cliente($id_mesa_cliente) {
            return $this-> id_cliente = $id_mesa_cliente;
        }
    }
?>